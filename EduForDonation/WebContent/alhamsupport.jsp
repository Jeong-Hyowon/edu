...
<body>
	...
	<nav class="navbar navbar-default">
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav">
				...
				<li class="active"><a href="alhamsupport.jsp">알락달락/함성소리
						사전연수회</a></li>
	...
	<center><p>2018-12-31 00:00:00 ~ 2019-01-12 00:00:00</p></center>
	<div class="container">
		<div class="row">
			<table class="table table-striped"
				...
				<tbody>
					<%
						...
						ArrayList<HamSung> list = hamsungDAO.getList(pageNumber);
						for (int i = 0; i < list.size(); i++) {
					%>
					<tr>
						<td><%=list.get(i).getSupportID()%></td>
						<td><a
							href="viewSupport3.jsp?SupportID=<%=list.get(i).getSupportID()%>"><%=list.get(i).getName().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;")
			...
			<%
				if (pageNumber != 1) {
			%>
			<a href="alhamsupport.jsp?pageNumber=<%=pageNumber - 1%>"
			...
			%>
			<a href="write2.jsp" class="btn btn-primary pull-right">지원하기</a>
		</div>
		<form action="<%=request.getContextPath()%>/searchList3.jsp"
			method="get">
			<center>
				<select name="sk">
