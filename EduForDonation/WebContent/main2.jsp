	...
	<nav class="navbar navbar-default">
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav">
				...
				<li><a href="mainsupport2.jsp">대교단 집행부 지원 올리기</a></li>
				<li><a href="socsupport2.jsp">쏙쏙캠프 사전연수회 신청 올리기</a></li>
				<li><a href="alhamsupport2.jsp">알락달락/함성소리 사전연수회 신청 올리기</a></li>
			...
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					...
					<ul class="dropdown-menu">
						...
						<li><a href="membermanager.jsp">회원목록</a></li>
					</ul></li>
			</ul>
			<%
				}
