...
if(Passwd.length() > 1 && CPhone.length() < 1){
		pstmt = conn.prepareStatement("UPDATE MEMBER SET Passwd = ? WHERE EmailID = ?");
...
else if(CPhone.length() > 1 && Passwd.length() < 1){
	pstmt = conn.prepareStatement("UPDATE MEMBER SET CPhone = ? WHERE EmailID = ?");
	...
	pstmt = conn.prepareStatement("UPDATE MEMBER SET Passwd = ?, CPhone = ? WHERE EmailID = ?");
