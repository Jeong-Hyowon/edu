			...
			<table class="table table-striped"
				...
				<tbody>
					<%
						...
						ArrayList<SocSoc> list2 = socsocDAO.getList(pageNumber);
					...
					<tr>
						...
						<td><a
							href="viewSupport2.jsp?SupportID=<%=list2.get(i).getSupportID()%>"><%=list2.get(i).getName().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;").replaceAll(">", "&gt;").replaceAll("\n", "<br>")%></a></td>
						<td><%=list2.get(i).getEmailID()%></td>
						<td><%=list2.get(i).getSupportDate().substring(0, 11) + list2.get(i).getSupportDate().substring(11, 13)
						+ "시" + list2.get(i).getSupportDate().substring(14, 16) + "분"%></td>
					</tr>
					<%
						}}
					%>
