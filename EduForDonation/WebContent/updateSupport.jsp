...
<body>
	...
	<div class="container">
		<div class="row">
			<form action="post"
				action="updateAction.jsp?SupportID=<%=SupportID%>">
					...
					<tbody>
						<tr>
							<td><input type="text" class="form-control" placeholder="이름"
								name="name" maxlength="20" value="<%=Main.getName()%>"></td>
						</tr>
						<tr>
							<td><textarea class="form-control" placeholder="지원부서 및 지원동기"
									name="reasonForApplication" maxlength="300"
									style="height: 350px;"><%=Main.getReasonForApplication()%>"></textarea></td>
						</tr>
						<tr>
						<td><textarea class="form-control" placeholder="자신의 장단점"
								name="prosAndCons" maxlength="300" style="height: 350px;"><%=Main.getProsAndCons()%>"></textarea></td>
						</tr>
						<tr>
						<td><textarea class="form-control"
								placeholder="하고싶은 프로그램이 있다면?" name="programYouWant"
								maxlength="300" style="height: 350px;"><%=Main.getProgramYouWant()%>"></textarea></td>
					</tr>
					</tbody>
				</table>
				<a href="mainsupport.jsp" class="btn btn-primary">목록</a> <input
