...
<jsp:useBean id="main2" class="web.AdminSupport" scope="page" />
<jsp:setProperty property="start" name="main2" />
<jsp:setProperty property="end" name="main2" />
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<body>
	...
	<%
		...
		String start = "2018-12-11 00:00:00";
		
		String end = "2018-12-23 00:00:00";
					...
					<tbody>
						<tr>
							...
							<td><textarea class="form-control"
									placeholder="지원부서 및 지원동기(300자 제한)" name="reasonForApplication"
									maxlength="300" style="height: 350px;"></textarea></td>
							<td><textarea class="form-control"
									placeholder="자신의 장단점(300자 제한)" name="prosAndCons"
									maxlength="300" style="height: 350px;"></textarea></td>
							<td><textarea class="form-control"
									placeholder="하고싶은 프로그램이 있다면?(300자 제한)" name="programYouWant"
									maxlength="300" style="height: 350px;"></textarea></td>
					</tbody>
				</table>
				<input type="submit" class="btn btn-primary pull-right" value="지원하기">
	...
	<%
			...
			PrintWriter script = response.getWriter();
			script.println("<script>");
			script.println("alert('지원기간이 아닙니다!')");
