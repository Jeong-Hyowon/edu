...
<body>
	...
	<div class="container">
		<div class="row">
			<form action="post"
				action="updateAction3.jsp?SupportID=<%=SupportID%>">
				<table class="table table-striped"
					style="text-align: center; border: 1px solid #dddddd">
					<thead>
						<tr>
							<th colspan="3"
								style="background-color: #eeeeee; text-align: center;">알락달락/함성소리 신청서 수정</th>
						</tr>
					</thead>
					<tbody>
<tr>
						...
						<tr>
							<td><textarea class="form-control" placeholder="부서명"
									name="department" maxlength="300"
									style="height: 350px;"><%=Main.getDepartment()%>"></textarea></td>
						</tr>
						<tr>
						<td><textarea class="form-control" placeholder="사이즈명"
								name="size" maxlength="300" style="height: 350px;"><%=Main.getSize()%>"></textarea></td>
						</tr>
						
					</tbody>
				</table>
				<a href="alhamsupport.jsp" class="btn btn-primary">목록</a> <input
